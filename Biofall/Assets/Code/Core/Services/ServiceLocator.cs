...
{
    // Ported from The Office. It stays a locator only while three rules hold:
    //   - resolve once, in Awake / Start / OnNetworkSpawn, and cache the result in a field;
    //   - never resolve from Update, a constructor or a static initializer;
    //   - register a service only through the ServiceInstaller of its own assembly.
